...
AW.Panels.Vertical.create = function(){
	...
	left.setContent("html", function(){return this.getPanel(0)});
	center.setContent("html", function(){return this.getPanel(1)});
	right.setContent("html", function(){return this.getPanel(2)});
