...
var $header = {toString: function(){
	...
	var s = "";
	s += site.head("ActiveWidgets", "Professional JavaScript Code");
	s += site.menu(	"<a href='readme.htm'>Readme</a>",
					...
					"<a href='http://www.activewidgets.com/aw.ui.grid/'>Documentation</a>|" +
...
var $footer = {toString: function(){
	var s = "";
	s += site.foot();
	s += site.copyright("Copyright &copy; 2003-2011 ActiveWidgets SARL. All Rights Reserved.");
	return s;
}};
