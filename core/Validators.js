...
export const Validators = {
  ...
  required: (value, message = 'This field is required') => {
    // 0 и false — валидные значения (количество=0, выключенный чекбокс);
    // проверка !value отвергала бы их вместе с пустыми
  ...
  min: (minVal, message = `Minimum value is ${minVal}`) => {
    return (value) => {
      // Проверка на null/undefined/'' вместо !value: число 0 — валидный ввод,
      // !0 === true пропускал бы его мимо проверки (min(5) на 0 молчал)
