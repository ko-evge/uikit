...
export declare class Select extends Base {
  ...
  focus(): void;
  click(): void;
  /** Открывает нативный попап программно (Chrome 101+/Firefox 98+, иначе focus+click) */
  showPicker(): void;
}

export declare class DropdownMenu extends Base {
  constructor(label?: string);
  /** label '---' добавляет разделитель. opts: { key?: string; disabled?: boolean } */
  addItem(label: string, fn?: () => void, opts?: { key?: string; disabled?: boolean }): this;
  addGroup(groupLabel: string, items?: Array<{ label: string; fn?: () => void; opts?: object }>): this;
}
...
export declare class Grid extends Base {
  ...
  getSelectedRows(): any[];
  clearSelection(): this;
  /** Callback стиля строки: возвращает объект CSS-свойств или null */
  setRowStyle(fn: (row: any) => object | null): this;
  /** Индекс текущей строки в отфильтрованных/отсортированных данных (filteredRows), -1 если нет */
  currentRow: number;
  /** Отфильтрованные и отсортированные данные — currentRow индексирует именно их */
  filteredRows: any[];
}
...
export declare class Dialog extends Base {
  ...
  setFillSpace(fill?: boolean): this;
  getHeader(): HTMLElement | null;
  setHeaderContent(content: string | HTMLElement | Base): this;
  getFooter(): HTMLElement;
  /** { 'F2': fn, 'Escape': fn, ... } — срабатывает только когда диалог верхний в стеке */
  setFKeys(fkeys: { [key: string]: () => void }): this;
  show(): this;
  hide(): this;
  close(): this;
...
export declare class VerticalLayout extends Base {
  constructor();
  getTop(): HTMLElement | null;
  getMiddle(): HTMLElement | null;
  getBottom(): HTMLElement | null;
  setTopHeight(px: number): this;
  setBottomHeight(px: number): this;
  setTopContent(content: string | HTMLElement | Base): this;
  setMiddleContent(content: string | HTMLElement | Base): this;
  setBottomContent(content: string | HTMLElement | Base): this;
  appendToTop(element: HTMLElement | Base): this;
  appendToMiddle(element: HTMLElement | Base): this;
  appendToBottom(element: HTMLElement | Base): this;
}

export declare class HorizontalLayout extends Base {
  constructor();
  getLeft(): HTMLElement | null;
  getMiddle(): HTMLElement | null;
  getRight(): HTMLElement | null;
  setLeftWidth(px: number): this;
  setRightWidth(px: number): this;
  setLeftContent(content: string | HTMLElement | Base): this;
  setMiddleContent(content: string | HTMLElement | Base): this;
  setRightContent(content: string | HTMLElement | Base): this;
  appendToLeft(element: HTMLElement | Base): this;
  appendToMiddle(element: HTMLElement | Base): this;
  appendToRight(element: HTMLElement | Base): this;
}
...
export declare const UIKit: {
  ...
  dropdownMenu(label?: string): DropdownMenu;
  combo(placeholder?: string): Combo;
  select(placeholder?: string): Select;
