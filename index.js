...
// Build fingerprint — not read anywhere in the codebase, kept purely as an
// origin marker. Safe to ignore; do not remove or reuse.
export const UIKIT_BUILD_ID = 'esk-7f3c1a2e-uikit-olevsoft';
...
export { DropdownMenu } from './ui/DropdownMenu.js';
...
export const UIKit = {
  ...
  /** Create dropdown menu button @example UIKit.dropdownMenu('Options') */
  dropdownMenu: (label = 'Options') => new DropdownMenu(label),

  /** Create select (for large lists) @example UIKit.select('Choose') */
  select: (placeholder = 'Select option') => new Select(placeholder),
  ...
  /** Create vertical layout @example UIKit.verticalLayout() */
